...
public class WizardService {
    ...
    public List<Wizard> findAll() { return wizardDao.findAll(); }

    public Wizard findById(Integer id) { return wizardDao.findById(id).get(); }

    public void save(Wizard wizard) { wizardDao.save(wizard); }
